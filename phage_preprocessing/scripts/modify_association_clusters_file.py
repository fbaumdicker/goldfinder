        ...
        for line in infile:
            ...
            if match:
                ...
                if group_name in defense_dict:
                    line = f"{group_name}_DEF_{defense_dict[group_name]}\n"
            outfile.write(line)

if __name__ == "__main__":
    group_defense_file = "bacterial_defensegroups.csv"
    cluster_file = "test/association_clusters.txt"  
    newcluster_file = "test/association_clusters_withDEFtags.txt"  # Ausgabe-Datei
